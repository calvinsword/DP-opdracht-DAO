...
//        sietske.voegToeOVChipkaart(ov1);
//        sietske.voegToeOVChipkaart(ov2);
//        rdao.save(sietske);
//
//
...
//
//        //Reiziger ToString met OVChipkaart
//        System.out.println("\nReiziger ToString met OVChipkaart");
//        System.out.println(sietske);
//
//        //Extra test dat het halen van reiziger ook de OVChipkaarten bevat
//        System.out.println("\nExtra test dat het halen van reiziger ook de OVChipkaarten bevat");
//        Reiziger reizigerTest = rdao.findById(77);
...
//    }
    ...
    public static void testProductDAO(ReizigerDAO rdao,OVChipkaartDAO odao, ProductDAO pdao) throws Exception {
        ...
        producttestov.addProduct(testproduct);
        ...
        producttestov.removeProduct(testproduct);
        odao.update(producttestov);
